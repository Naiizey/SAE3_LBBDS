...
CREATE OR REPLACE VIEW produit_global AS
    ...
    code_sous_cat
    FROM _produit
    NATURAL JOIN _vendeur NATURAL JOIN _compte;
...
SELECT concat(id_prod, '£', id_quidi) id, id_prod, intitule_prod, stock_prod, prix_ttc, prix_ht, lien_image,  description_prod, id_quidi, num_compte num_vendeur, moyenne_note_prod
