                                    ...
                                    foreach ($avis as $cle => $unAvis): ?>
                                        <div class="divUnAvis" <?php if ($unAvis->num_avis == $avisEnValeur) {echo 'id="avisEnValeur"';} ?>>
                                            ...
                                            <?php if (session()->has("numero")): ?>
                                                ...
                                                <div class="divSignalement" id="<?= "divSignalement".$unAvis->num_avis ?>">
                                                    <h2>Signaler un commentaire</h2>
                                                    <hr>
                                                    <div class="divUnAvis divSignalUnAvis">
                                                        <section class="sectionUnAvis">
                                                            <div class="divNomCommentaire">
                                                                <img src="<?= base_url() ?>/images/header/profil.svg">
                                                                <div class="divNomDate">    
                                                        ...
                                                        <form action="<?= current_url() ?>" method="post">
                                                            <input required="required" type="text" name="raison" placeholder="Entrez la raison de votre signalement">
                                                            <div>
                                                                <a class="annulerSignal">Annuler</a>
                                                                <input type="hidden" name="num_avis" value="<?= $unAvis->num_avis ?>">
