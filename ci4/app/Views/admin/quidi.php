                ...
                <div>
                    ...
                    <div>
                        <div class="h3PasArticlePanier">
                            ...
                            <h3><a href="<?= base_url() ?>/catalogue" class="lienPasArticlePanier">Cliquez ici</a>, pour
                                continuer vos recherches.</h3>
                        </div>
        ...
        <?php else: ?>
            <section class="sectionPanier">
                <div class="divPanierArticles">
                    <div class="divPanierHeader">
                        <h2>Votre panier (<span class="nbArt">
                                <?= sizeof($produits) ?>
                            </span> article.s) :</h2>
                        <h3>Prix</h3>
                    </div>
                        ...
                        <article id="<?= $produit->id ?>" class="articlePanier">
                            ...
                            <div>
                                <div class="divQuantite">
                                    <p>Quantité</p>
                                    <input class="" type="number" name="quantite" min=1 max=<?= $produit->stock ?>
...
<script>
    ...
    <?php endif; ?>
    <?php if (
        session()->has("numeroClient") && has_cookie("token_panier")
